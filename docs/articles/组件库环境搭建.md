...
如果你不想一步步的搭建，想直接使用现成的话，你可以直接把项目clone下来->**[kittyui第一版](https://gitee.com/geeksdidi/kittyui/tree/44e3268cf6e8bdb24d447341c545f80c075c456c)**,然后你只需要以下几步便可将其完成
...
如果你对组件开发感兴趣的话欢迎关注下面的[专栏](https://juejin.cn/column/7118932817119019015)

**下一篇**

* [button组件的开发](https://juejin.cn/post/7121381989864701982)
